...
// Description: HQ/nlmeans_light_sharpen_denoise.glsl: Slow, but higher quality. Sharpen and denoise. Tuned for light noise.
...
//!BIND G
//!BIND GC
//!DESC Non-local means (HQ/nlmeans_light_sharpen_denoise.glsl)
