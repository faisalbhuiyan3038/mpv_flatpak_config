...
// Description: HQ/nlmeans_light_sharpen_only.glsl: Slow, but higher quality. Noise resistant sharpening without denoising. Tuned for light noise.
...
#ifdef LUMA_raw
#define S 1.6010122216285405
#else
#define S 2.129871522259278
#endif
...
#ifdef LUMA_raw
#define AS 2
#define ASF 0.47386133138685804
#define ASA 0.6168668956629192
#define ASP 0.9277989922627791
#define ASS 0.3728270730612147
#define ASI 0
#else
#define AS 2
#define ASF 0.7074439247635824
#define ASA 0.43193604089631205
#define ASP 2.3149954680382554
#define ASS 0.6733466943317543
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.37080361608975876
#else
#define SW 1.1561045490291422
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.7865753060200334
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.7207090060084761
#define PST 0
#define PSS 0.0
#endif
 ...
 */
#ifdef LUMA_raw
#define RO 0.00010838715671324979
#else
...
//!BIND G
//!BIND GC
//!DESC Non-local means (HQ/nlmeans_light_sharpen_only.glsl)
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 0.6251879264562343
#else
#define S 1.3486848363235688
#endif
...
#ifdef LUMA_raw
#define AS 2
#define ASF 0.5914826394179873
#define ASA 0.5291360115180199
#define ASP 1.7612902511162871
#define ASS 0.269061329868389
#define ASI 0
#else
#define AS 2
#define ASF 0.4709144092419473
#define ASA 0.2644085071922597
#define ASP 1.103171331402653
#define ASS 0.20676523991335324
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 2.145511112765442
#else
#define SW 0.9143482619920884
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.09426129349653961
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.07913944435163962
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.061635174326898114
#define WDP 0.530943516545355
#define WDS 1.0
#else
#define WD 0
#define WDT 0.0
