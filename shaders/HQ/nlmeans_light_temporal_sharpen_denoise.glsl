...
// Description: HQ/nlmeans_light_temporal_sharpen_denoise.glsl: Slow, but higher quality. Very experimental and buggy, limited to vo=gpu-next. Sharpen and denoise. Tuned for light noise.
...
#ifdef LUMA_raw
#define S 2.566851840803873
#else
#define S 3.4051956025134977
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.42076626085281355
#define ASA 0.46882335919240675
#define ASP 0.8156930261292498
#define ASS 0.19169619327563478
#define ASI 0
#else
#define AS 1
#define ASF 0.7036131138721584
#define ASA 0.6132876572266078
#define ASP 1.6595474713132203
#define ASS 0.25767680299378776
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.4298793748216583
#else
#define SW 0.4968163237220899
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.2881582756555048
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 1.07840876227171
#define PST 0
#define PSS 0.0
#endif
 ...
 */
#ifdef LUMA_raw
#define RO 6.824550578413988e-05
#else
...
//!BIND PREV1
//!BIND PREV2
//!DESC Non-local means (HQ/nlmeans_light_temporal_sharpen_denoise.glsl)
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 0.9696865508783988
#else
#define S 0.5520742553596307
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.4598056959171616
#define ASA 0.229897843677499
#define ASP 2.8227794590362016
#define ASS 0.10708839257016194
#define ASI 0
#else
#define AS 1
#define ASF 0.5849691177052844
#define ASA 0.41321314140213944
#define ASP 1.0209796506413527
#define ASS 0.3237283096960552
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.605900593208959
#else
#define SW 2.428362669032721
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.10478269503021763
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.04248939834753444
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.05294397045844113
#define WDP 0.660630407694113
#define WDS 1.0
#else
#define WD 0
#define WDT 0.0
