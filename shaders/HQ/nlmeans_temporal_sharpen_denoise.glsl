...
// Description: HQ/nlmeans_temporal_sharpen_denoise.glsl: Slow, but higher quality. Very experimental and buggy, limited to vo=gpu-next. Sharpen and denoise.
...
#ifdef LUMA_raw
#define S 4.0812946522451385
#else
#define S 5.803429887590286
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.5616843944899826
#define ASA 0.39783193087505214
#define ASP 1.4033765704481835
#define ASS 0.16594244139019565
#define ASI 0
#else
#define AS 1
#define ASF 0.2737473062472458
#define ASA 0.6428481109780312
#define ASP 1.3265511074124048
#define ASS 0.2886170624305153
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.20610704550685566
#else
#define SW 0.5729540061989612
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.3127441251327459
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.553684312628787
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT 0.40291344218577707
#define WDP 0.0
#define WDS 1.0
#else
#define WD 0
 ...
 */
#ifdef LUMA_raw
#define RO 0.00020313233147077923
#else
...
//!BIND PREV1
//!BIND PREV2
//!DESC Non-local means (HQ/nlmeans_temporal_sharpen_denoise.glsl)
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 1.0726504019099357
#else
#define S 1.112368038570049
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.36819126274852493
#define ASA 0.8020136880808976
#define ASP 0.8738076056451772
#define ASS 0.31603700635891346
#define ASI 0
#else
#define AS 1
#define ASF 0.39115062485036184
#define ASA 0.5210557746459656
#define ASP 0.9090414403473224
#define ASS 0.30673529600042865
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.1609131595083764
#else
#define SW 3.2167403174206597
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.10327365652102455
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.03224115566559767
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.06425648663794674
#define WDP 1.6439803672851014
#define WDS 1.0
#else
#define WD 0
#define WDT 0.0
...
#else
#define RO 9.472298424256143e-05
#endif
