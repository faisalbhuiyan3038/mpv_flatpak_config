...
// Description: LQ/nlmeans_light_sharpen_denoise.glsl: Faster, but lower quality. Sharpen and denoise. Tuned for light noise.

//!HOOK LUMA
//!HOOK CHROMA
//!BIND HOOKED
//!DESC Non-local means (LQ/nlmeans_light_sharpen_denoise.glsl)
