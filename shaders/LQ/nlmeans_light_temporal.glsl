...
// Description: LQ/nlmeans_light_temporal.glsl: Faster, but lower quality. Very experimental and buggy, limited to vo=gpu-next. Tuned for light noise.
...
//!BIND PREV1
//!BIND PREV2
//!DESC Non-local means (LQ/nlmeans_light_temporal.glsl)
...
#ifdef LUMA_raw
#define S 1.8555397743407305
#else
#define S 1.7060120561458985
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.247436333679896
#else
#define SW 0.8162767040224023
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.6403669172904966
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS -0.04761447378002117
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.45919359452571706
#define WDP 4.060529880332482
#define WDS 1.0
#else
#define WD 0
#define WDT 0.0
