...
// Description: LQ/nlmeans_light_temporal_sharpen_denoise.glsl: Faster, but lower quality. Very experimental and buggy, limited to vo=gpu-next. Sharpen and denoise. Tuned for light noise.
...
#ifdef LUMA_raw
#define S 1.81923877052313
#else
#define S 1.9771160008089983
#endif
...
#ifdef LUMA_raw
#define AS 1
#define ASF 0.854552663366013
#define ASA 0.28663677395456216
#define ASP 1.0589062205853852
#define ASS 0.1831281867373581
#define ASI 0
#else
#define AS 1
#define ASF 0.5424125006757734
#define ASA 0.34959410860065726
#define ASP 0.9835507516488539
#define ASS 0.11028962933047107
#define ASI 0
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 1.0282186539629152
#else
#define SW 0.4375184387984543
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.4867629589098778
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS -0.03444411872552048
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.4642797830967218
#define WDP 2.4441971702855363
#define WDS 1.0
#else
#define WD 0
#define WDT 0.0
