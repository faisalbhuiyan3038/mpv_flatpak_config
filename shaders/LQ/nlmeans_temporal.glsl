...
// Description: LQ/nlmeans_temporal.glsl: Faster, but lower quality. Very experimental and buggy, limited to vo=gpu-next.
...
//!BIND PREV1
//!BIND PREV2
//!DESC Non-local means (LQ/nlmeans_temporal.glsl)
